...
AUTHORIZATION = "CAPTURE_ONE_SHOT_BINANCE_USDM_PUBLIC_MICROSTRUCTURE_V1_1"
...
def validate_public_read_only_microstructure_snapshot_v1_1(directory: Path | str) -> dict[str, Any]:
    ...
    _req(int(summary["depth_limit_requested"]) == DEPTH_LIMIT, "SNAPSHOT_DEPTH_LIMIT_INVALID", "summary")
    _req(tuple(int(x) for x in summary["depth_bands_bps"]) == DEPTH_BANDS_BPS, "SNAPSHOT_DEPTH_BANDS_INVALID", "summary")
    ...
    return {
        ...
        "depth_bands_bps": list(summary["depth_bands_bps"]),
        "manifest_entries": 3,
...
def capture_public_read_only_microstructure_snapshot_v1_1(
    *,
    repo_root: Path | str,
    ...
    try:
        ...
        summary = {
            ...
            "request_count": 7,
            "depth_limit_requested": DEPTH_LIMIT,
        ...
        temp.rename(out)
        validation = validate_public_read_only_microstructure_snapshot_v1_1(out)
        return {
            "capability": CAPABILITY,
