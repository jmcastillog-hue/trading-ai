...
def is_bearish_rejection_candle(
    ...
    body_bearish = close_price < open_price
    ...
    close_below_mid = close_price < (
        low_price + candle_range * 0.5
    )

    return (
        body_bearish
        and upper_wick_ratio >= min_upper_wick_ratio
        and close_below_mid
    )


def find_ltf_rejection_entry_in_fib_zone(
    ltf_df,
    start_time,
    zone_low,
    zone_high,
    ...
    for _, candle in candidates.iterrows():
        ...
        rejection = is_bearish_rejection_candle(
            candle,
            min_upper_wick_ratio=min_upper_wick_ratio
        )
        ...
        if rejection:
            ...
            return {
                ...
                "entry_reason": "BEARISH_REJECTION"
            }
...
def run_mtf_fib_short_backtest_v2(
    htf_df,
    ltf_df,
    min_drop_pct=5,
    max_impulse_bars=80,
    ...
    for swing_high in swing_highs:
        ...
        entry = find_ltf_rejection_entry_in_fib_zone(
            ltf_df=ltf_df,
