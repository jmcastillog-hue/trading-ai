...
from src.backtesting.mtf_fib_walk_forward import (
...
def print_final_report(report):
    ...
    print("\n=== MTF FIB WALK FORWARD VALIDATION ===\n")
...
def main():
    ...
    summary_df.to_csv(
        "reports/mtf_fib_walk_forward_summary.csv",
        index=False
    )

    trades_df.to_csv(
        "reports/mtf_fib_walk_forward_test_trades.csv",
        index=False
    )
    ...
    print(
        "Resumen guardado en: reports/mtf_fib_walk_forward_summary.csv"
    )

    print(
        "Trades TEST guardados en: reports/mtf_fib_walk_forward_test_trades.csv"
    )
